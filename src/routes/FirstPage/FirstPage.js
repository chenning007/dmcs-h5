...
const design_exam = [{
  ...
  key: 4,
  src: 'http://47.92.126.195:80/image/firstpage/shili4.png',
  description: 'IPT22105/22106 IPCAN电源转换节点', 
  },/*{
  key: 5,
  src: 'http://47.92.126.195:80/image/firstpage/shili5.png',  
            ...
            <div style={{zIndex:0}}>
              ...
              <div style={{background:'#ffffff'}}>
                <div style={{marginBottom: 8, marginTop: 12 }}>
                  <span style={{fontSize:28}}> 
                    <img style={{ width:'2%'}} src="http://47.92.126.195:80/image/firstpage/u2327.png"/>
                    &nbsp;&nbsp;解决方案
                  </span>
                  <span style={{float:'right', marginRight: 16, marginTop:8}}>
              ...
              <div style={{ background:'#f0f2f5'}}>
                <div style={{marginBottom: 8, marginTop: 16 }}>
                  <span style={{fontSize:28,}}>
                    <img style={{ width:'2%'}} src="http://47.92.126.195:80/image/firstpage/u26.png"/>
                    &nbsp;&nbsp;科研成果
                  </span>
                  <span style={{float:'right', marginRight: 16, marginTop:8}}>
              ...
              <div style={{ background:'#ffffff'}}>
                <div style={{marginBottom: 8, marginTop: 16, marginTop:8 }}>
                  <span style={{fontSize:28,}}>
                    <img src="http://47.92.126.195:80/image/firstpage/u26.png"/>
                    &nbsp;&nbsp;合作方式
                  </span>
                  <span style={{float:'right', marginRight: 16, marginTop:8}}>
                    <Button type='primary' onClick={() => this.loadmore(3)}>
